...
public class AutoRScaleRight extends CommandGroup {
	public AutoRScaleRight() {
		...
		addSequential(new ArcProfile(84, 92, Constants.vCruise+40, 0, 0, 36, Constants.acc));
		addSequential(new ArcProfile(224, 90, Constants.vCruise+40, 0, 36, 36, Constants.acc));
		addSequential(new ArcProfile(24, 180, Constants.vCruise+40, 0, 10, 0, Constants.acc));
